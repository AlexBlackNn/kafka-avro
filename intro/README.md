...
Такие файлы-логи объеденяются в **партиции**. А набор партиций составляет **топик**.  Топики в Kafka могут иметь одного или нескольких продьюсеров/консьюмеров, а также могут не иметь их вовсе. 
