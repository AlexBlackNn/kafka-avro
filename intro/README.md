...
Некоторые элементы Kafka-cluster, например такие как: Zookeeper, Consumer Group, которые вы видите на рисунке, остались
нераскрытыми, с ними вы познакомитесь дальше. 
