...
вы наверное заметили, что мы не использовали Schema registry, c ним мы познакомимся позже (Прим. в ведении не будет раскрыт, пример использования см в example-transaction, где передается сообщение в формате avro).  
