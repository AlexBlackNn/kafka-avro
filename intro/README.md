...
Настало время запустить код продьюсера! Внимание! Не забудьте установить [librdkafka](https://github.com/confluentinc/librdkafka#installation)
...
пример реализации можно найти в директории *avro-example*
...
Отметим, что в отличие от RabbitMQ, в Kafka отсутствует понятие *очереди*. Вместо этого приложения взаимодействуют с *партиционированными топиками*,
